/*
  ...
  - You are about to drop the column `finised` on the `workouts` table. All the data in the column will be lost.
  - Added the required column `finished` to the `workouts` table without a default value. This is not possible if the table is not empty.
